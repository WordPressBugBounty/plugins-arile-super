...
<section class="theme-main-slider" id="theme-slider">
    <div id="theme-main-slider" class="owl-carousel owl-theme">
		<?php 
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide25.jpg);">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg">
					    <h5 class="sub-title"><?php esc_html_e('BEST DESIGN SERVICES','arile-super'); ?></h5>
						<h1 class="title-large"><?php esc_html_e('INTERIOR & ARCHITECT','arile-super'); ?></h1>
